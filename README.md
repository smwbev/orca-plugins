...
|---|---|---|---|
| [Русский](https://github.com/smwbev/orca-russian) | `smwbev.russian` | `languages` | A complete Russian translation of the Orca interface — 13,904 strings, 99.1 % of the catalog |
  ...
  "plugins": [
    {
      ...
      "source": {
        ...
        "ref": "v5.1.142"           // tag, branch, or commit
      },
      "description": "…",
