...
|---|---|---|---|
| [Русский](https://github.com/smwbev/orca-russian) | `smwbev.russian` | `languages` | A complete Russian translation of the Orca interface — 11,742 strings, 98.2 % of the catalog |
  ...
  "plugins": [
    {
      ...
      "source": {
        ...
        "ref": "v5.1.3"           // tag, branch, or commit
      },
      "description": "…",
