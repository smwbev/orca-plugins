...
|---|---|---|---|
| [Русский](https://github.com/smwbev/orca-russian) | `smwbev.russian` | `languages` | A complete Russian translation of the Orca interface — 11,907 strings, 98.5 % of the catalog |
  ...
  "plugins": [
    {
      ...
      "source": {
        ...
        "ref": "v5.1.8"           // tag, branch, or commit
      },
      "description": "…",
